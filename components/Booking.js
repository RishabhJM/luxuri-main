...
export default function Booking() {
  return (
    <div
      className="h-fit bg-cover bg-center p-10 md:px-10 md:py-16"
      style={{
        backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0) 80%, rgba(0,0,0,1)),linear-gradient(to top, rgba(0,0,0,0) 80%, rgba(0,0,0,1)),url(/pexels-photo-113578555.jpg)`,
      }}
    >
      <div className="mb-4">
        ...
        >
          {PROPERTIES_DATA.map((t) => (
            <div className="rounded-3xl border-2 border-gray-500" key={t.key}>
              <div className="flex justify-center border-b-2 w-auto h-[250px] se:h-[320px] relative border-gray-500">
                <Image className="rounded-t-3xl" src={t.src} fill></Image>
                {/* <div className="rooms-label">{t.rooms}</div> */}
              </div>
              <div className="bg-[#181818] rounded-b-3xl lg:h-[120px]">
